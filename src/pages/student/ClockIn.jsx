...
import { isClockInTime, formatTime } from '../../utils/time';
...
export default function ClockIn() {
  ...
  const checkTimeAndLocation = async () => {
    // Check time
    if (!isClockInTime()) {
      setError('Clock in hanya dapat dilakukan antara pukul 07:30 - 08:00');
      return;
    }
  ...
  const handleClockIn = async () => {
    if (!canClockIn) {
      setError('Tidak dapat melakukan clock in. Periksa waktu dan lokasi Anda.');
      return;
    }
    ...
    try {
      ...
      await ApiService.clockIn(clockInData);
      ...
      <div className="max-w-2xl mx-auto">
        <div className="card-gradient p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">Clock In</h1>
            <p className="text-gray-700 font-medium">Waktu clock in: 07:30 - 08:00</p>
            <p className="text-lg font-mono font-bold bg-gradient-to-r from-purple-600 to-orange-600 bg-clip-text text-transparent mt-2">
              {formatTime(new Date())}
            </p>
          </div>
          ...
          <div className="space-y-6">
            {/* Location Status */}
            <div className="card-gradient border-2 border-purple-200 p-6">
              <h3 className="font-semibold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-4 flex items-center">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-medium text-blue-800">Informasi Clock In</h4>
                  <div className="mt-2 text-sm text-blue-700">
                    <ul className="list-disc list-inside space-y-1">
                      <li>Clock in hanya dapat dilakukan antara pukul 07:30 - 08:00</li>
                      <li>Jarak maksimal dari kantor ditentukan oleh pengurus</li>
                      <li>Pastikan GPS aktif untuk validasi lokasi</li>
                      <li>Status otomatis akan menjadi WFO setelah clock in</li>
                    </ul>
                  </div>
                </div>
              </div>
