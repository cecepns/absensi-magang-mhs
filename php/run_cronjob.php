<?php
/**
 * Wrapper Script untuk Cronjob
 * 
 * Script ini menekan deprecation warnings dari third-party libraries
 * (seperti Roundcube) sebelum menjalankan script utama.
 * 
...
// Include dan jalankan script utama
require_once __DIR__ . '/send_attendance_emails.php';
